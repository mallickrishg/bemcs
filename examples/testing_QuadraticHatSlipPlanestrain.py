...
# %% compute slip
# Most importantly return slip at the center of each mesh element.
dr = 1e-9
K_ux_p, K_uy_p, _, _, _ = GF.get_kernels_quadratichatslip_planestrain(
    els.x_centers + dr * els.x_normals,
    els.y_centers + dr * els.y_normals,
    els,
    connect_matrix,
    mu,
    nu,
)
K_ux_m, K_uy_m, _, _, _ = GF.get_kernels_quadratichatslip_planestrain(
    els.x_centers - dr * els.x_normals,
    els.y_centers - dr * els.y_normals,
    els,
    connect_matrix,
